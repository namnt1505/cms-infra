...
import { TaskSettings } from './task_settings.json';
import { Rules } from './rules-props';
import { BaseConstruct } from '../base';

class DmsReplication extends BaseConstruct {
  ...
  public createSubnetGroup(props: DmsProps): CfnReplicationSubnetGroup {
    const subnet = new CfnReplicationSubnetGroup(this, 'dms-subnet-group', {
      ...
      replicationSubnetGroupDescription:
        'Private subnets that have access to my data source and target',
  ...
  //       `dms.${this.envConfig.region}.amazonaws.com`,
  //     ),
  //   });
  ...
  private createReplicationInstance(props: DmsProps): CfnReplicationInstance {
    const instance = new CfnReplicationInstance(
      this,
      'dms-replication-instance',
      {
        replicationInstanceClass:
          props.replicationInstanceClass || 'dms.t3.medium',
  ...
  public createMySQLEndpoint(
    ...
    const endpoint = new CfnEndpoint(
      this,
      `mysql-${endpointType}-${endpointIdentifier}`,
      {
        endpointIdentifier,
        endpointType,
        engineName: 'mysql',
  ...
  public createOracleEndpoint(
    ...
    const endpoint = new CfnEndpoint(
      this,
      `oracle-${endpointType}-${endpointIdentifier}`,
      {
        endpointIdentifier,
        endpointType,
        engineName: 'oracle',
  ...
  public createAuroraPostgresEndpoint(
    ...
    const endpoint = new CfnEndpoint(
      this,
      `aurora-postgresql-${endpointType}-${endpointIdentifier}`,
      {
        endpointIdentifier,
        endpointType,
  ...
  public createPostgresEndpoint(
    ...
    const endpoint = new CfnEndpoint(
      this,
      `postgresql-${endpointType}-${endpointIdentifier}`,
      {
        endpointIdentifier,
        endpointType,
        engineName: 'postgres',
  ...
  public createSqlServerEndpoint(
    ...
    const endpoint = new CfnEndpoint(
      this,
      `sqlserver-${endpointType}-${endpointIdentifier}`,
      {
        endpointIdentifier,
        endpointType,
  ...
  public createReplicationTask(
    ...
    const replicationTask = new CfnReplicationTask(
      this,
